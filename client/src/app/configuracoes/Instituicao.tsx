            ...
            <div className="card-corpo">
              ...
              <fieldset disabled={so || salvando} style={{ border: 0, padding: 0, margin: 0, minWidth: 0 }}>
                <div className="form-sec"><h3>Identificação</h3><div className="form-grade">
                  ...
                  <CampoTexto rotulo="CNPJ" name="cnpj" formato="cnpj" value={v('cnpj')} onChange={def('cnpj')} erros={campos} />
                ...
                <div className="form-sec"><h3>Vinculação e mantenedora</h3><div className="form-grade">
                  ...
                  <CampoTexto rotulo="CNPJ da mantenedora" name="mantenedora_cnpj" formato="cnpj" value={v('mantenedora_cnpj')} onChange={def('mantenedora_cnpj')} erros={campos} />
                </div></div>
                ...
                <div className="form-sec"><h3>Endereço</h3><div className="form-grade">
                  ...
                  <CampoTexto rotulo="CEP" name="cep" formato="cep" value={v('cep')} onChange={def('cep')} erros={campos} />
                ...
                <div className="form-sec"><h3>Contato</h3><div className="form-grade">
                  <CampoTexto rotulo="Telefone" name="telefone" formato="telefone" value={v('telefone')} onChange={def('telefone')} erros={campos} />
                  <CampoTexto rotulo="Telefone secundário" name="telefone_secundario" formato="telefone" value={v('telefone_secundario')} onChange={def('telefone_secundario')} erros={campos} />
