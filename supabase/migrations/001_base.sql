-- ==========================================================
-- 001_base — estado do banco ANTES da Secretaria Digital
-- (formulário de visitas, avaliação substitutiva, staff_emails).
-- Migrations são imutáveis e aplicadas em ordem no SQL Editor do
-- Supabase. Em bancos já existentes, este script é idempotente.
-- ==========================================================
